...
| **`BasisSetTaxonomyPlan.md`** | V1.33: the BasisSet taxonomy ruling — **libraries follow the FAMILY (engine), module names carry the GROUP**; §1 is the pin (an IBS = a carrier of one irrep of G; construction = subduce or induce), §3 the current→target library map, §4 the 5-step running order | live — agreed 2026-09-13; steps 1–2 done, step 3 (audit) next |
