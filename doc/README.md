...
| **`BasisSetTaxonomyPlan.md`** | V1.33: the BasisSet taxonomy ruling — **libraries follow the FAMILY (engine), module names carry the GROUP**; §1 is the pin (an IBS = a carrier of one irrep of G; construction = subduce or induce), §3 the current→target library map, §4 the 5-step running order | RECORD — executed in full 2026-09-13 (11 commits, 856/856); §1 is the standing design, §4 the execution log |
