...
| **`SpaceGroupPlan.md`** | space groups in `qcSymmetry`; workspace `~/Code/qchem7`, branch `lattice-3d-spacegroup` | live, separate tree |
...
| **`SymmetryRefactorPlan.md`** | the `qcSymmetry` library reorg | IN PROGRESS on branch `symmetry-refactor`, unmerged |
...
| **`SphericalSALCPlan.md`** | spherical SALC adaptation | shippable; only S3b (libcint-spherical) left, guarded out |
...
| **`APIErgonomicsReview.md`** | the binding-side view of the public interfaces | live feedback; drives the facade work |
...
|---|---|
| **`GPWPlan.md`** | ★ the 2026-07 GPW campaign AND the **durable pins** (THERE IS NO CUT; policy enums not numeric dials).  **Read its pins before working in GPW.**  Its TODO section is superseded by `GPWPlan1.md` |
...
Fully executed and superseded.  Retired 2026-09-08: `PlaneWavePlan.md` + `PlaneWavePlan-2.md` (PW-DFT
shipped), `AO_FT_ProjectionCleanup.md` (self-declared DONE, all three moves), `ScreeningPlan.md`
(self-declared *CLOSED — NOT A LIVE PLAN*).  Earlier: `GaussianPlaneWavePlan.md`, `MolecularBasisSetPlan.md`,
