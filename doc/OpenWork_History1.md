# Open Work — HISTORY 1 (retired 2026-08-19)

> **This file is CLOSED.  The live tracker is `doc/OpenWork.md` (v2).**
>
> Retired when the tracker was re-cut around the 2026-08-19 plan.  Everything below is kept for the
> record — the closed threads A–E (spherical SALC scaffolding, spin-native DFT, the namespace sweep,
> the test→facade migration, retiring QchemTester), the 2026-06-30 and 2026-08-15 orderings, and the
> runtime-campaign rounds 1–4 as they were written down at the time.  The still-OPEN items were ported
> forward into the v2 tracker; nothing here is a live to-do.  Read it when you need the reasoning or
> the measurements behind a decision the v2 tracker only cites.
