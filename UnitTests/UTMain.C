...
//     testing::GTEST_FLAG(filter) = "Multiple/A_SGm_HF_P.Multiple/4";
     testing::GTEST_FLAG(filter) = "Multiple/A_SGm_HF_P.Multiple/*:Multiple/A_SG_DFT_P.Multiple/*";
//     testing::GTEST_FLAG(filter) = "Multiple/A_SLm_HF_P.Multiple/*:Multiple/A_SL_DFT_P.Multiple/*";
//     testing::GTEST_FLAG(filter) = "Multiple/A_PG_HF_P.Multiple/*";
