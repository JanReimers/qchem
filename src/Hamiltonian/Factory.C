...
export namespace qchem::Hamiltonian
{
    ...
    Hamiltonian* Factory(Pol,const st_t& st,ExFunctional* , const qcMesh1::MeshParams&, const bs_t*); //DFT version
    Hamiltonian* Factory(Pol,const st_t& st,double alpha  , const qcMesh1::MeshParams&, const bs_t*); //DFT version
