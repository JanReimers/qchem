...
WaveFunction* HamiltonianImp::CreateWaveFunction(const BasisSet* bs,const ElectronConfiguration* ec) const
{
    return IsPolarized ? (WaveFunction*)new Polarized_WF(bs,ec) : (WaveFunction*)new UnPolarized_WF(bs,ec);
}
