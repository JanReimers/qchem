...
{
template <class T, class TFit> const ERI3<TFit>& Orbital_DFT_IBS<T,TFit>::Overlap3C  (const FIT_SF_ABS<TFit>& c) const
{
...
template <class T, class TFit> const ERI3<TFit>& Orbital_DFT_IBS<T,TFit>::Repulsion3C(const FIT_CD_ABS<TFit>& c) const
{
