...
Fit_IBS* Orbital_IBS::CreateCDFitBasisSet(const Structure* cl, const qcMesh1::MeshParams& mp) const
{
...
Fit_IBS* Orbital_IBS::CreateVxcFitBasisSet(const Structure* cl, const qcMesh1::MeshParams& mp) const
{
