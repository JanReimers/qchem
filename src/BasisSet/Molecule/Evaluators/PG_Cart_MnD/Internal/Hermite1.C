// File: BasisSet/Molecule/Evaluators/PG_Cart_MnD/Internal/Hermite1.C  Class for managing 1 function Hermite coefficients
module;

#include <iosfwd>

#define LMAX 3
export module qchem.BasisSet.Molecule.Evaluators.PG_Cart_MnD.Internal.Hermite1;
