// File: PolarizedGaussian1/Readers/Gaussian94.C  Class for reading basis sets from a Gaussian 94 formatted file.
module;
#include <iostream>
#include <cassert>
#include <memory>
...
#include <unistd.h>
#include <vector>
module qchem.BasisSet.Molecule.PolarizedGaussian1.Internal.Readers.Gaussian94;
