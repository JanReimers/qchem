// File: PolarizedGaussian1/MnD/Imp/Hermite2.C  Class for managing 2 function Hermite coefficients
module;
...
module qchem.BasisSet.Molecule.PolarizedGaussian1.Internal.MnD.Hermite2;
