// File: BasisSet/Molecule/PolarizedGaussian1/MnD/Imp/Triangle3D.C  A 3-index triangular data structure.
module;
#include <cassert>
#include <iostream>
#include <vector>
module qchem.BasisSet.Molecule.PolarizedGaussian1.MnD.Triangle3D;
import qchem.stl_io;
