// File: PolarizedGaussian1/MnD/Imp/RNLM.C  Manager the RNLM Auxillary functions.
module;
#include <iostream>
#include <cassert>
#include <vector>
module qchem.BasisSet.Molecule.PolarizedGaussian1.Internal.MnD.RNLM;
import qchem.BasisSet.Molecule.PolarizedGaussian1.Internal.AuxillaryFJ;
import qchem.IntPow;
