// File: BasisSet/Molecule/PolarizedGaussian1/MnD/Triangle3D.C  A 3-index triangular data structure.
module;
#include <iosfwd>
#include <vector>
export module qchem.BasisSet.Molecule.PolarizedGaussian1.MnD.Triangle3D;
