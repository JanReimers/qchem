// File: PolarizedGaussian1/MnD/Hermite1.C  Class for managing 1 function Hermite coefficients
module;

#include <iosfwd>

#define LMAX 3
export module qchem.BasisSet.Molecule.PolarizedGaussian1.Internal.MnD.Hermite1;
