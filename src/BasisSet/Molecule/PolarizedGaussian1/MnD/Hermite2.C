// File: PolarizedGaussian1/MnD/Hermite2.C  Class for managing 2 function Hermite coefficients
module;
...
export module qchem.BasisSet.Molecule.PolarizedGaussian1.Internal.MnD.Hermite2;
