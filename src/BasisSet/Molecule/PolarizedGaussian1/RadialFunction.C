...
#include <set>
#include <map>
export module qchem.BasisSet.Molecule.PolarizedGaussian1.Internal.RadialFunction;
...
public:
    ...
    // One radial type now, so no peel-off dispatch: exactly three entry points.
    //   this is centre A (2C),  C (3C: <ab|c>),  D (4C: (ab|cd)).
