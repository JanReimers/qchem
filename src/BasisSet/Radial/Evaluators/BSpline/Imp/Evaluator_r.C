// File: BasisSet/Radial/Evaluators/BSpline/Imp/IBS_r_Evaluator.C
module;
...
module qchem.BasisSet.Radial.Evaluators.BSpline.IBS_r;
...
namespace qchem::BasisSet::Radial::Evaluators::BSpline
{
