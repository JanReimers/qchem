// File: BasisSet/Radial/Evaluators/BSpline/Internal/GLQuadrature.C Perform Gauss-Legendre quadrature integration over B-Splines.
module;
#include <functional>
...
#include <iostream>
#include <map>
export module qchem.BasisSet.Radial.Evaluators.BSpline.Internal.GLQuadrature;
import qchem.Types;
