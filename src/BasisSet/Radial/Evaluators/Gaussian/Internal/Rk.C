// File: BasisSet/Radial/Evaluators/Gaussian/Internal/Rk.C  Slater inrtegrals for radial Gaussian functions. 
module;
export module qchem.BasisSet.Radial.Evaluators.Gaussian.Internal.Rk; 
