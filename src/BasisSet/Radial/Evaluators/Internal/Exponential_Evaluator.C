// File: BasisSet/Radial/Evaluators/Internal/Exponential_Evaluator.C  Common base for Slater and Gaussian evaluators
module;
#include <string>
#include <vector>
#include <cassert>
...
export module qchem.BasisSet.Radial.Evaluators.Internal.ExponentialEvaluator;
...
export namespace qchem::BasisSet::Radial::Evaluators
{
