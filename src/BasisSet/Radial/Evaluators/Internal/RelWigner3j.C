// File: BasisSet/Radial/Evaluators/Internal/RelWigner3j.C  Wigner 3j symbols with half-integer arguments.
module;
export module qchem.BasisSet.Radial.Evaluators.Internal.RelWigner3j;
