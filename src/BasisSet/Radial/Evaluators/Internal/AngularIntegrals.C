// File: BasisSet/Radial/Evaluators/Internal/AngularIntegrals.C  Handle the angular part of 2-electron ERIs
module;
export module qchem.BasisSet.Radial.Evaluators.Internal.AngularIntegrals;
