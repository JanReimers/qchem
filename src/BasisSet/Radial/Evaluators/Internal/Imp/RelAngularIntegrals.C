// File: BasisSet/Radial/Evaluators/Internal/Imp/RelAngularIntegrals.C
module;
#include <cassert>
#include <cmath>            // std::abs (double)
#include <initializer_list> // the {-0.5, 0.5} spin loops

module qchem.BasisSet.Radial.Evaluators.Internal.RelAngularIntegrals;
import qchem.BasisSet.Radial.Evaluators.Internal.AngularIntegrals;
import qchem.BasisSet.Radial.Evaluators.Internal.Wigner3j; //Wigner::wigner3j / clebschGordan (home-grown)
