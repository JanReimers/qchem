// File: BasisSet/Radial/Evaluators/Internal/Wigner3j.C  Compile-time Wigner 3j symbols (home-grown).
//
...
export module qchem.BasisSet.Radial.Evaluators.Internal.Wigner3j;
