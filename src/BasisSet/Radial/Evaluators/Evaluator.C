// File: BasisSet/Radial/Evaluator.C
module;
#include <iosfwd>
#include <concepts>
#include "forward.H"
export module qchem.BasisSet.Radial.Evaluators;
...
public:
    ...
    // (No EmitRadialReport here -- V1.14: an exponent shell ANNOUNCES its exponents at its own construction;
    //  nobody tells it to.  See ExponentialEvaluator::Announce.)
