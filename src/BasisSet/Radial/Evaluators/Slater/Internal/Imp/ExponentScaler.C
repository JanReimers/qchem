// File: src/BasisSet/Radial/Evaluators/Slater/Internal/Imp/ExponentScaler.C  Rescale Slater exponents based in angular momentum L.
module;
module qchem.BasisSet.Radial.Evaluators.Slater.Internal.ExponentScaler;
import qchem.BasisSet.Radial.Internal.FillPower;
