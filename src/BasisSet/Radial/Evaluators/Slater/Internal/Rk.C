// File: src/BasisSet/Radial/Evaluators/Slater/Internal/Rk.C  Slater integrals for radial Slater functions.
module;
export module qchem.BasisSet.Radial.Evaluators.Slater.Internal.Rk; 
