// File::BasisSet/Radial/Factory.C  Factory function for atom basis sets.
module;
...
import qchem.BasisSet.Radial.Evaluators.Slater.IBS;
import qchem.Math;
import qchem.Blaze;

using json = nlohmann::json;

namespace qchem::BasisSet::Radial
{
