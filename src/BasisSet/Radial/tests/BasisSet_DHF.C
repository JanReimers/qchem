...
public:
    ...
    {
        bs1=BasisSet::Radial::Factory(js,Z);
        bs2=BasisSet::Radial::Factory(js,Z);
    }
    // void InitBSpline6() {Init({{"type",BasisSet::Radial::Type::BSpline6},{"N", N}, {"rmin", 0.1}, {"rmax", 10}},BasisSetAtom::Type::BSpline6);}
    void InitGaussian() {Init({{"type",BasisSet::Radial::Type::Gaussian_RKB},{"N", N}, {"emin", 0.1}, {"emax", 10}});}
    void InitSlater  () {Init({{"type",BasisSet::Radial::Type::Slater_RKB  },{"N", N}, {"emin", 0.1}, {"emax", 10}});}
