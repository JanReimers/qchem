...
public:
    ...
    void Orthogonality(BasisSet::Radial::Type type)
    {
...
{
    Orthogonality(BasisSet::Radial::Type::Slater);
}
TEST_F(BasisSetPoolTests,GaussianOrthogonality)
{
    Orthogonality(BasisSet::Radial::Type::Gaussian);
}
TEST_F(BasisSetPoolTests,BSplineOrthogonality)
{
    Orthogonality(BasisSet::Radial::Type::BSpline6);
}
