...
public:
    ...
    {
        nlohmann::json js = {{"type",BasisSet::Radial::Type::Slater_RKB}, {"N", 3}, {"emin", 0.1}, {"emax", 10.0} };
        sbs=BasisSet::Radial::Factory(js,2);
        js = {{"type",BasisSet::Radial::Type::Gaussian_RKB}, {"N", 3}, {"emin", 0.1}, {"emax", 10.0} };
        gbs=BasisSet::Radial::Factory(js,2);
