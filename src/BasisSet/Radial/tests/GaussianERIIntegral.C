...
import qchem.BasisSet.Radial.Evaluators.Gaussian.IBS;
import qchem.BasisSet.Radial.Evaluators.Internal.Rk;
import qchem.BasisSet.Radial.Evaluators;

import qchem.BasisSet.Radial.Internal.Wigner3j;
...
TEST_F(GaussianRadialERITests, R0_0000)
{
    ...
    EXPECT_DOUBLE_EQ(expected,R.Direct (0,0,0,0));
}
...
TEST_F(GaussianRadialERITests, R0_0000_Random)
{
    for (int i=0; i<10; i++)
    {
        ...
        GaussianRadialIntegrals R(ab,cd);
        double expected=FourPi2*Pi12/8*(1/(ab*cd*sqrt(ab+cd)));
        EXPECT_NEAR(expected,R.Direct (0,0,0,0),5e-12);
    }
}
...
TEST_F(GaussianRadialERITests, R0_1100)
{
    ...
    EXPECT_DOUBLE_EQ(expected,R.Direct (1,1,0,0)/R.Direct (0,0,0,0));
}
...
TEST_F(GaussianRadialERITests, R0_1100_Random)
{
    for (int i=0; i<10; i++)
    {
        Randomize();
        GaussianRadialIntegrals R(ab,cd);
        double expected=R.Direct (0,0,0,0)*(1/ab+1/(2*(ab+cd)));
        EXPECT_NEAR(expected,R.Direct (1,1,0,0),6e-10);
    }
}
...
{
    GaussianRadialIntegrals R(ab,cd);
    double expected=R.Direct (0,0,0,0)*(1/cd+1/(2*(ab+cd)));
    EXPECT_DOUBLE_EQ(expected,R.Direct (0,0,1,1));
}
...
{
    GaussianRadialIntegrals R(ab,cd);
    double expected=R.Direct (0,0,0,0)*(3/(2*(ab+cd)));
...
{
    GaussianRadialIntegrals R(ab,cd);
    double expected=R.Direct (0,0,0,0)*3/4*(2/(ab*cd)+1/((ab+cd)*(ab+cd)));
    EXPECT_DOUBLE_EQ(expected,R.Direct (1,1,1,1));
}
TEST_F(GaussianRadialERITests, R2_1111)
{
    ...
    double expected=R.Direct (0,0,0,0)*15/4*(1/abcd2);
...
TEST_F(GaussianRadialERITests, R3_1212)
{
    ...
    double abcd=ab+cd;
    double abcd3=abcd*abcd*abcd;
    double expected=R.Direct (0,0,0,0)*105/(8*abcd3);
...
TEST_F(GaussianRadialERITests, R4_2222)
{
    ...
    double expected=R.Direct (0,0,0,0)*945/(16*abcd4);
...
TEST_F(GaussianRadialERITests, R2_2222)
{
    ...
    double abcd=ab+cd;
    double abcd4=abcd*abcd*abcd*abcd;
    double expected=R.Direct (0,0,0,0)*105/(8*abcd4)*(cd/ab+ab/cd+9./2.);
...
TEST_F(GaussianRadialERITests, R0_2222)
{
    ...
    EXPECT_DOUBLE_EQ(expected,R.Direct (2,2,2,2)/R.Direct (0,0,0,0));
}
...
TEST_F(GaussianRadialERITests, R0_1122)
{
    ...
    EXPECT_DOUBLE_EQ(expected,R.Direct (1,1,2,2)/R.Direct (0,0,0,0));
}
...
TEST_F(GaussianRadialERITests, R0_0022)
{
    ...
    EXPECT_DOUBLE_EQ(expected,R.Direct (0,0,2,2)/R.Direct (0,0,0,0));
}
