...
import qchem.BasisSet.Radial.Evaluators.BSpline.IBS;
import qchem.BasisSet.Radial.Evaluators.BSpline.IBS_r;
...
public:
        ...
        , cl(new Atom(1,0.0,Vector3D(0,0,0)))
    {
        ...
        itsMesh=AtomMesh(*cl,500,3,2.0, 0);
    }
    void Init(int N, double rmin, double rmax)
    {
        nlohmann::json js = {
        {"type",BasisSet::Radial::Type::BSpline6},
        {"N", N}, {"rmin", rmin}, {"rmax", rmax},
        };
        bs=BasisSet::Radial::Factory(js,75);
...
// {
//     using namespace qchem::BasisSet::Radial::Evaluators::BSpline;
