...
public:
    ...
    virtual Fit_IBS* CreateCDFitBasisSet (const Structure*, const qcMesh::MeshParams&) const=0;
    virtual Fit_IBS* CreateVxcFitBasisSet(const Structure*, const qcMesh::MeshParams&) const=0;
