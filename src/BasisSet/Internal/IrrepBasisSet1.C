...
export template <class T> class IrrepBasisSet_Common1
    : public virtual IrrepBasisSet1<T>
{
public:
    IrrepBasisSet_Common1(Symmetry* sym) : itsSymmetry(sym) 
    {
        assert(itsSymmetry);
    };
    IrrepBasisSet_Common1(const Irrep_QNs::sym_t& sym) : itsSymmetry(sym) 
    {
        assert(itsSymmetry);
    };
