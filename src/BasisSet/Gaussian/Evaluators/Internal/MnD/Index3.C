// File: BasisSet/Gaussian/Evaluators/Internal/MnD/Index3.C
//
...
// PG_Cart::Polarization.  The Cartesian layer converts: Polarization IS implicitly an Index3
// (it adds the monomial x^n y^l z^m on top), and a future Spherical layer would supply its own indices.
export module qchem.BasisSet.Gaussian.Evaluators.Internal.MnD.Index3;
