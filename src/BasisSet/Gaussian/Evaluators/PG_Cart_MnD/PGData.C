// File: BasisSet/Gaussian/Evaluators/PG_Cart_MnD/PGData.C  Flattened rep of PG IBS suitable for integral evaluation.
module;
#include <vector>
#include <string>

export module qchem.BasisSet.Gaussian.Evaluators.PG_Cart_MnD.PGData;
