// File: BasisSet/Gaussian/Evaluators/PG_Cart_MnD/Internal/Imp/Hermite2.C  Class for managing 2 function Hermite coefficients
module;
...
module qchem.BasisSet.Gaussian.Evaluators.PG_Cart_MnD.Internal.Hermite;
