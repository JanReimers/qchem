// File: BasisSet/Gaussian/Evaluators/Evaluator.C
//
...
#include <iosfwd>
#include <concepts>
export module qchem.BasisSet.Gaussian.Evaluators;
...
export namespace qchem::BasisSet::Gaussian::Evaluators
{
...
// IBS mixins (qchem.BasisSet.Gaussian.Point.IBS), mirroring the atom Integrals_*<E> / Orbital_*_IBS<E> pattern.
//
