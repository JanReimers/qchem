// File: BasisSet/Gaussian/Evaluators/PG_LibCint/Imp/Evaluator.C
//
...
module qchem.BasisSet.Gaussian.Evaluators.PG_LibCint;
...
namespace qchem::BasisSet::Gaussian::Evaluators::PG_LibCint
{
