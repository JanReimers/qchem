// File: BasisSet/Gaussian/Point/Readers/Imp/Gaussian94.C  Reader for Gaussian-94 formatted basis-set files.
module;
#include <iostream>
#include <cassert>
...
#include <unistd.h>
#include <vector>
module qchem.BasisSet.Gaussian.Point.Readers.Gaussian94;
