// File BasisSet/Gaussian/PG_Spherical/BasisSet.C
//
...
#include <vector>
#include <memory>
export module qchem.BasisSet.Gaussian.Point.PG_Spherical;
import qchem.BasisSet.Gaussian.Evaluators.PG_Cart_MnD.GaussianRF;        // the radial (shared with PG_Cart)
import qchem.BasisSet.Gaussian.Point.Reader;
import qchem.BasisSet.Gaussian.Evaluators.PG_Spherical_MnD;              // NR_Evaluator: the IBS IS-A evaluator
import qchem.BasisSet.Gaussian.Point.IBS;                                      // Gaussian::Orbital_{1E,HF}_IBS<E> mixins
...
export namespace qchem::BasisSet::Gaussian::PG_Spherical
{
namespace Sph = ::qchem::BasisSet::Gaussian::Evaluators::PG_Spherical_MnD;
namespace Cart = ::qchem::BasisSet::Gaussian::Evaluators::PG_Cart_MnD;
...
class IrrepBasisSet
    ...
    public:
        ...
        virtual std::string BasisSetID() const {return SphData::BasisSetID();} // geometry-aware cache identity (molecular: no RadialID/AngularID)
...
class Orbital_IBS
    : public Gaussian::EOrbital_1E_IBS<Sph::NR_Evaluator>
    , public Gaussian::Orbital_ERI4_IBS <Sph::NR_Evaluator>
    , public Gaussian::Orbital_DFT_IBS<Sph::NR_Evaluator>
...
public:
    ...
    virtual std::vector<Symmetry::Molecule::AoShell> GetAoShells() const override;   // Gaussian::Orbital_1E_IBS
};
