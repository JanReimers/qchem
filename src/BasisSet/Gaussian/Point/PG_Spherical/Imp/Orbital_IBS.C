// File: BasisSet/Gaussian/Point/PG_Spherical/Imp/Orbital_IBS.C  Spherical-Gaussian 2-centre fit integrals.
//
// The orbital 1E / 3C (DFT) / 4C (HF) integral building lives entirely in the Molecule-generic,
// evaluator-templated mixins (qchem.BasisSet.Gaussian.Point.IBS), instantiated with the spherical NR_Evaluator.
