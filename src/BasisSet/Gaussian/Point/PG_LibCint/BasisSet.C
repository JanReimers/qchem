// File: BasisSet/Gaussian/Point/PG_LibCint/BasisSet.C
//
...
#include <vector>
#include <memory>
export module qchem.BasisSet.Gaussian.Point.PG_LibCint;
...
import qchem.BasisSet.Gaussian.Evaluators.PG_LibCint;   // NR_Evaluator: the IBS IS-A evaluator base
...
export namespace qchem::BasisSet::Gaussian::PG_LibCint
{
namespace Cart = ::qchem::BasisSet::Gaussian::Evaluators::PG_Cart_MnD;
namespace LC   = ::qchem::BasisSet::Gaussian::Evaluators::PG_LibCint;
...
class Orbital_IBS
    : public Gaussian::EOrbital_1E_IBS<LC::NR_Evaluator>
    , public Gaussian::Orbital_ERI4_IBS<LC::NR_Evaluator>
