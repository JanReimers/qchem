// File: BasisSet/Gaussian/tests/M_PGSymmetry.C  PG basis -> symmetry bridge (stage 5 wiring) on a real basis.
...
using namespace qchem::BasisSet::Gaussian::PG_Cart;
...
using SymmetryAdaptedBasisSet  = ::qchem::BasisSet::Gaussian::SymmetryAdaptedBasisSet;
