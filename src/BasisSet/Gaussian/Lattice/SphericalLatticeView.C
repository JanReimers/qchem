// File: BasisSet/Gaussian/Lattice/SphericalLatticeView.C
//
// The SPHERICAL LATTICE VIEW (doc/SphericalLatticePlan.md I1): a Real_BS whose single orbital block
// answers Real_OIBS + Gaussian::LatticeSum1E in the SPHERICAL span -- the peer implementation the GPW
...
// held ONLY through the abstract faces (Gaussian::Orbital_1E_IBS + LatticeSum1E), so whichever engine
...
module;
#include <memory>
export module qchem.BasisSet.Gaussian.Lattice.SphericalLatticeView;
