...
public:
    ...
    virtual Fit_IBS* CreateCDFitBasisSet(const Structure* cl, const MeshParams&) const;
    virtual Fit_IBS* CreateVxcFitBasisSet(const Structure* cl, const MeshParams&) const;
