...
public: 
    ...
    Gaussian_IBS(const omlv_t& es, int l, const is_t& mls) : Gaussian_IBS(convert(es),l,mls) {}
    Gaussian_IBS(const   ds_t& es, int l) : Gaussian_IBS(es,l,{}) {}
    Gaussian_IBS(const omlv_t& es, int l) : Gaussian_IBS(es,l,{}) {}
...
{
public:
    Gaussian_RKBS_IBS(const omlv_t& es, int _kappa, int l, const is_t& mls) : Gaussian_IBS(es,l,mls), kappa(_kappa) {ns=norms();}
    Gaussian_RKBS_IBS(const omlv_t& es, int _kappa, int l) : Gaussian_RKBS_IBS(es,_kappa,l,{}) {}
