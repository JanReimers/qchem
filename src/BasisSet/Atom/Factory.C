...
export namespace BasisSetAtom
{
    ...
    enum class Type {Slater,Gaussian,BSpline6,BSpline9,BSpliner6,BSpliner9,BSpline16,Slater_RKB,Gaussian_RKB,BSpline_RKB};
...
export namespace BasisSetAtom1
{
    // enum class Type {Slater,Gaussian,BSpline6,BSpline9,BSpliner6,BSpliner9,BSpline16,BSpline19,BSpline1r6,BSpline1r9,Slater_RKB,Gaussian_RKB,BSpline_RKB};
    enum class Type {BSpline6};
    BasisSet1* Factory(Type,const nlohmann::json& js,const ElectronConfiguration& ec);
    BasisSet1* Factory(Type,const nlohmann::json& js,size_t Z); //Use atomic number Z to deduce the ElectronConfiguration
    BasisSet1* Factory(const nlohmann::json& js,size_t Z); //Type is in the json object
}
