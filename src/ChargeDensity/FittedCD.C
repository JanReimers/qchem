...
import qchem.Fitting.FunctionFitter;   // Fitting::DensityFFClient (the fit request) + ScalarFunction
...
{
public:
    virtual void    DoFit          (const Fitting::DensityFFClient&)      =0;  //!< "fit me to this density"
