...
// FFT grid THROUGH the fitter -- "one owner", instead of the term cross-casting the fit basis a second
// time.  The XC quadrature object now holds the fit basis and reads its BasisSet::Quadrature face
