...
export namespace BasisSet1::Atom
{
    ...
    enum class Type {Slater,Gaussian,BSpline6,Gaussian_RKB};
    BasisSet1::Real_BS* Factory(Type,const nlohmann::json& js,const ElectronConfiguration& ec);
    BasisSet1::Real_BS* Factory(Type,const nlohmann::json& js,size_t Z); //Use atomic number Z to deduce the ElectronConfiguration
    BasisSet1::Real_BS* Factory(const nlohmann::json& js,size_t Z); //Type is in the json object
}
